...
class ObjectsTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      $objects = array(
        ...
        ['name' => 'Nintendo64', 'value' => 140, 'category_id' => 1, 'user_id' => 1, 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ['name' => 'Placa Poster Decorativo Metal Cocacola', 'value' => 40, 'category_id' => 13, 'user_id' => 4, 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ...
        ['name' => 'PlayStation3', 'value' => 1190, 'category_id' => 1, 'user_id' => 4, 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ['name' => 'Pulsar RS 200', 'value' => 12000, 'category_id' => 10, 'user_id' => 7, 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ['name' => 'Mi nombre es Skywalker', 'value' => 60, 'category_id' => 8, 'user_id' => 3, 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ['name' => 'Cargador Portatil Power Bank 10000', 'value' => 65, 'category_id' => 3, 'user_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ['name' => 'Lampara luces 3600 Ojo de Angel', 'value' => 110, 'category_id' => 15, 'user_id' => 7, 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ...
        ['name' => 'Teclado Inalámbrico Logitech Touch', 'value' => 120, 'category_id' => 2, 'user_id' => 6, 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ['name' => 'Call Of Duty', 'value' => 100, 'category_id' => 1, 'user_id' => 4, 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ...
        ['name' => 'SmartWatch Gear', 'value' => 1100, 'category_id' => 3, 'user_id' => 5, 'created_at' => new DateTime, 'updated_at' => new DateTime],
